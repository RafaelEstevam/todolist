            ...
            '<ul data-index="' + item.index +'" id="'+item.id+'" class="main-tasks main-rounded">' +
                '<li class="main-task-item main-rounded main-bg-gray "' +
                    ...
                    '" data-total-score="'+ item.totalScore +'">' + 
                        ...
                        '<div class="main-task-info d-flex align-items-center"><span class="font-weight-bold main-text-deep">Pontuação: </span><span class="ml-3 main-circle main-bg-deep main-task-label">' + item.score + '</span></div>' +
                        '<div class="main-task-info d-flex align-items-center"><span class="font-weight-bold main-text-deep">Pontuação total: </span><span class="ml-3 main-circle main-bg-deep main-task-label">' + item.totalScore + '</span></div>' +
                        '<div class="main-task-info d-flex align-items-center"><span class="font-weight-bold main-text-deep">Subtaretas: </span><span class="ml-3 main-circle main-bg-deep main-task-label">' + item.subtask.length + '</span></div>' +
